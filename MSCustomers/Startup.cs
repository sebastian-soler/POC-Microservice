...
namespace MSCustomers
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<CustomerContext>(c => c.UseSqlServer(Configuration.GetConnectionString("CustomerDB")));
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "My Customer API", Version = "v1" });
            });
        }
