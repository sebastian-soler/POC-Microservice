...
namespace MSRegistry
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<UserContext>(c => c.UseSqlServer(Configuration.GetConnectionString("RegistryDB")));
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "My Registry API", Version = "v1" });
            });
        }
